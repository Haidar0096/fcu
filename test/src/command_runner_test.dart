...
void main() {
  group('FlutterCliUtilsCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterCliUtilsCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterCliUtilsCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterCliUtilsCommandRunner();
