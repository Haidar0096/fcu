  ...
  style: ButtonStyle(
    ...
    shape: WidgetStateProperty.resolveWith((states) {
      ...
      return RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(ThemeDefaults.buttonBorderRadius),
        side: borderSide,
      );
    }),
    ...
    textStyle: WidgetStateProperty.all(
      Typography.defaultButtonFont.textStyle.copyWith(fontSize: ThemeDefaults.buttonTextSize),
    ),
