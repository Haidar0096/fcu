...
TextSelectionThemeData textSelectionThemeData(ColorScheme colorScheme) {
  final cursorColor = colorScheme.brightness == Brightness.dark
      ? colorScheme
  ...
  return TextSelectionThemeData(
    ...
    selectionColor: colorScheme.primaryContainer.withValues(alpha: ThemeDefaults.textSelectionOpacity),
  );
}
