...
final class {{proj_name.pascalCase()}}ThemeLight extends {{proj_name.pascalCase()}}Theme {
  ...
  static const {{proj_name.pascalCase()}}ThemeLight instance = {{proj_name.pascalCase()}}ThemeLight._();
...
final class {{proj_name.pascalCase()}}ThemeDark extends {{proj_name.pascalCase()}}Theme {
  ...
  static const {{proj_name.pascalCase()}}ThemeDark instance = {{proj_name.pascalCase()}}ThemeDark._();
