...
import 'package:{{proj_name}}/common/networking/http_client_adapter/http_client_adapter.dart';
import 'package:{{proj_name}}/common/networking/http_client_adapter/http_response.dart';
import 'package:{{proj_name}}/common/networking/http_client_adapter/network_failure.dart';
        ...
        case dio.DioExceptionType.unknown
          ...
          return Result.failure(
            NetworkError(
              ...
              serverErrorMessage: serverErrorMessageResolver
                  ?.call(dioException.response?.toHttpResponse),
            ),
          );
...
extension DioResponseExtension<T> on dio.Response<T> {
  HttpResponse<T> get toHttpResponse => HttpResponse<T>(
